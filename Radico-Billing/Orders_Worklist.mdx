...
<Steps>
  ...
  <Step title="Enter Worklist Name">
    ...
    ![2025 07 08 15 15 15 Pn](/ow3.png)
  </Step>
  ...
  <Step title="Mark as Private">
    ...
    ![2025 07 07 12 42 13 Pn](/ow4.png)
  </Step>
  ...
  <Step title="Set Filter Conditions">
    ...
    ![2025 07 07 12 44 16 Pn](/ow7.png)
  </Step>
...
<Steps>
  <Step title="Steps" icon="chevron-down" titleSize="p">
    ...
    ![Ow9 Pn](/images/ow9.png)

    1. Click **Preview** to load the list of records missing ordering doctors.
    2. Use the **Filter** option to narrow down results if needed.
    3. Click the **Refresh** button to load the latest data.
    4. On the left panel, you’ll see the list of patients/studies without an ordering doctor. And on the right panel, the document opens where you can review the case.

    ![Ow9 1 Pn](/images/ow9.1.png)

    1. Add the missing Ordering Doctor directly within the document if available.
    2. After adding the ordering doctor, the record is auto-saved, and a toast message appears confirming “Record saved successfully.”
  </Step>
</Steps>
