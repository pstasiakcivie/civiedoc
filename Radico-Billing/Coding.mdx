...
The Coding Record interface opens when a user clicks the **View** ****Details (👁️) icon from the Preview Worklist screen or selects theStart Worklist****  option—available either at the top right corner or next to each listed worklist on the Coding Dashboard page. This interface provides comprehensive access to the coding workspace, enabling coders to:
