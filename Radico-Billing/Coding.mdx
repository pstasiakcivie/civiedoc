---
title: "Coding"
description: "The Coding module plays a vital role in streamlining healthcare billing by converting medical procedures, diagnoses, treatments, and services into standardized CPT and ICD codes. It helps coders manage daily workflows efficiently while ensuring compliance with industry standards. "
---

Coders can review clinical documentation, assign accurate codes, flag discrepancies (CAP). The module includes built-in quality checks, such as error and warning prompts, to support accurate billing and minimize denials.  

Users can create and manage coding worklists to organize tasks based on priority. These worklists can be configured as private or shared, depending on workflow requirements and team collaboration needs.
...
<Steps>
  ...
  <Step title="Mark as Private">
    ...
    **Allow Shared Users to Edit/Delete**: Grant editing privileges to shared users.
    ...
    <Tip>
      Enabled only when "**_Mark as Private_**" is unchecked.
    </Tip>
  </Step>
  ...
  <Step title="Preview Records">
    Click Preview to display matching records with columns like: Patient ID, Name, Accession Number, Modality, CPT/DX, Coding Status, Assigned To and Client Location.
  </Step>
...
<Steps>
  ...
  <Step title=" Start Coding">
    ...
    | Icon                    | Function                                                                                                      |
    | :---------------------- | :------------------------------------------------------------------------------------------------------------ |
    | **View Details**        | Opens the detailed view of the selected record, including tabs like Report, EH, Docs, Comments, and Activity. |
