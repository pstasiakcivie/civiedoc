...
<Steps>
  <Step title="Enter Worklist Details">
    ...
    **Select Category**: The **Coding** category is selected by default when creating a new worklist.
  ...
  <Step title="Define Filter Conditions">
    ...
    Group filters by selecting the **Group By** option to organize data (e.g., by Client, Location, or Status).
...
<Steps>
  <Step title="Search Bar">
    Use the **Search Patient** field at the top-left to quickly locate a coding record of the patient by Patient ID, Patient Name, MRN and Accession Numnber.
...
<Steps>
  ...
  <Step title="Charge ID">
    Click the **Charge ID** to \_c_heck the itemized list of services or procedures billed for that specific encounter.
