...
<Steps>
  <Step title="Open Create Coding Worklist">
...
<Steps>
  <Step title="Enter Worklist Details">
    ...
    **Select Category**: The category is by default set as **Coding**  when creating a new worklist.

    **Description (Optional)**: Provide a description in the **Description** field to define the worklist’s purpose.

    <img
      src="/17.png"
      alt="2025 07 07 12 26 38 Pn"
      title=""
      className="mx-auto"
    />
...
<Steps>
  ...
  <Step title="Change Privacy Settings">
    check the Mark as Private to restrict access to the current user only. Uncheck to allow sharing with other users.
...
<Steps>
  <Step title="Steps to delete a coding worklist:" icon="chevron-down">
    ...
    1. In the confirmation pop-up, click **Yes** to confirm and permanently delete the worklist.

    <img
      src="/f28.png"
      alt="2025 07 08 15 16 19 Pn"
      className="mx-auto"
      style={{ width:"77%" }}
    />
...
<Steps>
  <Step title="Select Records">
    ...
    <img
      src="/images/2025-07-23_17-47-28.png"
      alt="2025 07 23 17 47 28 Pn"
      className="mx-auto"
    />
  </Step>
  <Step title="Open the Mass Update">
    ...
    <img
      src="/images/2025-07-23_17-48-42.png"
      alt="2025 07 23 17 48 42 Pn"
      className="mx-auto"
      style={{ width:"90%" }}
    />
  </Step>
...
- **Left Panel:** Displays tabs such as **Report, ADT, Encounter History,** and others, allowing the user to navigate supporting information and documentation related to the encounter.
- **Right Panel:** Shows the **patient chart details** along with fields to enter or edit **CPT codes, ICD codes, Modifiers, NDCs,** and other coding elements.
...
- **Approve:** Finalize the coding record after review. This action updates the record status from In Progress to Approved and makes it ready for claim submission.
