...
This will take you to the main **Worklist Dashboard**, where you can create and manage worklists.
...
> ⚠️ **Warning:** Applicable only if you are creating a shared worklist (i.e., the **"Mark as Private"** checkbox is **unchecked**).
