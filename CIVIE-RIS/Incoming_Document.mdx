...
<Steps>
  ...
  <Step title="Upload Methods">
    **Drag & Drop files** or click **Browse to Upload** to select files manually.
    ...
    Select Location and document type (**Order Document, Insurance, Referral**). Click the <Icon icon="upload" /> **Upload** button.
  </Step>
</Steps>
...
<Accordion title="Search and Select the Document to Process" icon="file">
  <Steps>
    <Step title="On the Documents Dashboard:">
      ...
      Use the **Search** bar  or filters  to find a specific document. Click on the **Eye** icon  to view the document.
    </Step>
  </Steps>
</Accordion>
        ...
        **Right Panel-Document Details:** Shows metadata such as:
        ...
        <Steps>
          ...
          <Step title="Order Detail Field">
            Select, search, or add a new order. Use  <Icon icon="magnifying-glass" /> to search by **Exam Code, DOS, Patient Name etc**.
          </Step>
          <Step title="Manage Insurance Information">
            Select existing insurance or add a new entry as specified in the document. Click **Verify Eligibility** to check the insurance status.
          </Step>
