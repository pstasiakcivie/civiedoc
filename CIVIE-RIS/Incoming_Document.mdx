...
<Steps>
  ...
  <Step title="Filter Panel">
    - Click on the **Filters** and select from the available options: **Source, Document, Location, File name etc.**
...
<Steps>
  ...
  <Step title="Create a New Worklist">
    Click the <Icon icon="plus-large" iconType="solid" /> icon to initiate a new worklist.
  </Step>
...
<Accordion title="View & Search for a Document" icon="eye">
  <Steps>
    ...
    <Step title="Search">
      - Use the <Icon icon="magnifying-glass" iconType="solid" /> **Search bar** or filters to find a specific document.
    </Step>
    <Step title="View Document">
      - Click on the  <Icon icon="eye" iconType="sharp-solid" /> icon to preview the document.
    </Step>
  </Steps>
</Accordion>
...
<Steps>
  <Step title="Click the ✏️ Edit  icon to modify the document details">
    <Tabs>
