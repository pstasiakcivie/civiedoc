...
<Steps>
  ...
  <Step title="Add Employer Information">
    ...
    Click **\+ Add Employer**, then enter the details: **Employer Name, Website, Phone, Email, and Address**.
  ...
  <Step title="Enter Notes for the Appointment">
    ...
    Click **Add Note**, type in important details, and categorize as: **Important (Red), Warning (Yellow), or Information (Blue)**.
...
<Accordion title="Generating & Viewing Check-In QR Code" defaultOpen="false">
  <Steps>
    <Step title="Navigate to Appointment Summary">
      Open the **Appointment Summary** panel.

      Locate the **Booking Details** section.
    </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Notes" defaultOpen="false">
    ...
    - Click **Add Note** type in important details, and categorize as: **Important (Red), Warning (Yellow), or Information (Blue)**. Save the note to finalize it.
  </Accordion>
