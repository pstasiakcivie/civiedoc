  ...
  <Tab title="Booking and Managing Slots">
    ...
    <CardGroup cols={2}>
      <Card title="Appointment Booking" icon="book">
        ...
        1. 2,. The **Appointment Booking** pop-up appears.

        2. 3\. Select an existing patient or add a new patient.
      ...
      <Card title="Block Slot" icon="block">
        ...
        1. 5\. Enter the **From Date & Time** and **To Date & Time**.

        2. 6\. Click **Block** to finalize.
      </Card>
      ...
      <Card title="Open Slot" icon="check">
        ...
        1. 4\. Select the location using the dropdown.

        2. 5\. Choose the occurrence type: **Weekly, Monthly, or Custom**.

        3. 6\. Enter the **From Date & Time** and **To Date & Time**.



        1. 7\. Click **Submit** to confirm the open slot.
      </Card>
