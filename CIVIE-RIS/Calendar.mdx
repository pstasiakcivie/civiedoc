...
<Steps>
  ...
  <Step title="For a new patient fill in the details">
    * &#x20;Click on **+ icon** to Add new Pateint deatils
  ...
  <Tab title="Booking and Managing Slots">
    ...
    <CardGroup cols={2}>
      <Card title="Appointment Booking" icon="book">
        ...
        1. 4\. Add the referring physician or add a new referring physician.

        2. 5\. Search and add the required exams.

        3. 6\. In the **Documents section**, any available documents for the selected patient will be displayed.

        4. 7\. Click **Submit** to finalize the appointment.
      </Card>
      ...
      <Card title="Block Slot" icon="block">
        ...
        2. 2\. Enter a title for the blocked slot.

        3. 3\. Add a description (optional).

        4. 4\. Select the occurrence type: **Weekly, Monthly, or Custom**.

        5. 5\. Enter the **From Date & Time** and **To Date & Time**.

        6. 6\. Click **Block** to finalize.
      </Card>
      ...
      <Card title="Open Slot" icon="check">
        ...
        2. 2\. Enter a title for the open slot.

        3. 3\. Add a description (optional).

        4. 4\. Select the location using the dropdown.

        5. 5\. Choose the occurrence type: **Weekly, Monthly, or Custom**.

        6. 6\. Enter the **From Date & Time** and **To Date & Time**.

        7. 7\. Click **Submit** to confirm the open slot.
      </Card>

      <Card title="Running Late" icon="clock">
        1. Mark an appointment as running late and notify patients.

        2. 1\. Right-click on the **“+” icon** and select **Running Late**.

        3. 2\. Enter delay details and notify the patient.
      </Card>
      ...
      <Card title="Show Waitlist" icon="list">
        ...
        2. 2\. The **Waitlist window** opens, displaying patients on the waitlist for the selected slot.
      </Card>
    </CardGroup>
  </Tab>
...
Pending Documents & Forms: Send digital links for patient completion.
