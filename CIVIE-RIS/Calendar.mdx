  ...
  <Tab title="Booking and Managing Slots">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="Block Slot" icon="block">
        ...
        1. Enter the **From Date & Time** and **To Date & Time**.

        ![](/images/2025-03-0713_08_30-DEVv2Desktop-DesktopViewer.png)

        1. Click **Block** to finalize.
      </Card>
      ...
      <Card title="Open Slot" icon="check">
        ...
        1. Select the location using the dropdown.

        2. Choose the occurrence type: **Weekly, Monthly, or Custom**.

        3. Enter the **From Date & Time** and **To Date & Time**.

        ![](/images/2025-03-0713_08_30-DEVv2Desktop-DesktopViewer.png)

        1. Click **Submit** to confirm the open slot.
      </Card>
      ...
      <Card title="Running Late" icon="clock">
        ...
        1. Enter delay details and notify the patient.
      </Card>
      ...
      <Card title="Show Waitlist" icon="list">
        ...
        1. The **Waitlist window** opens, displaying patients on the waitlist for the selected slot.
      </Card>
    </CardGroup>
  </Tab>
