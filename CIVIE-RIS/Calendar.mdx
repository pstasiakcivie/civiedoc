...
## <Icon icon="filter-list" iconType="duotone" color="black" size="27" />  Filtering Appointments
...
## <Icon icon="address-card" iconType="duotone" color="black" size="27" />  Adding a New Appointment
...
<Steps>
  ...
  <Step title="For a new patient fill in the details">
    ...
    Click on **\+ icon** to Add new Patient details. Enter **Name, Gender, Preferred Language, Race, Marital Status, and Ethnicity**. Use the **Is Blocked** checkbox if a slot needs to be reserved.
...
## <Icon icon="computer-mouse" iconType="duotone" color="black" size="27" /> Right-Click Events
...
<Tabs>
  ...
  <Tab title="Managing Appointments">
    ...
    | |                                                                                                    | |
    | --- | -------------------------------------------------------------------------------------------------- | --- |
    | | The patient has confirmed the appointment via call, text, or email.                                | |
    | | The patient has arrived at the facility and completed the check-in process.                        | |
    | | The patient is in the pre-exam stage, such as filling out forms or undergoing initial assessments. | |
    | | A technician has acknowledged the appointment and is preparing to assist the patient.              | |
    | | The examination or procedure is currently being conducted.                                         | |
    | | The appointment has been successfully completed.                                                   | |
    | | The patient did not arrive for the scheduled appointment and did not notify the facility.          | |
    | | The appointment was cancelled either by the patient or the facility.                               | |
    | | The patient has reached the facility but has not yet checked in.                                   | |
    | | The appointment is temporarily paused due to unforeseen circumstances.                             | |
    | | The patient has informed the facility that they will arrive later than the scheduled time.         | |
    | |                                                                                                    | |
...
## <Icon icon="rectangle-list" iconType="duotone" color="black" size="27" /> Appointment Summary
...
## <Icon icon="angles-down" iconType="duotone" color="black" size="27" /> **Sending Check-In Link & QR Code**
...
## <Icon icon="eye" iconType="duotone" color="black" size="27" /> **View Appointment Details**
...
<AccordionGroup>
  ...
  <Accordion title="Booking Details" defaultOpen="false">
    ...
    Patient Name, MRN (Medical Record Number), DOB, Gender, Phone & Email and Billing Type (Medical Insurance)
  </Accordion>
