...
<Accordion title="To quickly locate a Order Worklist, use the search and filter options available in the worklist." icon="filter">
  <Steps>
...
<Accordion title="To create a customize worklist, follow these steps:" icon="List">
  <Steps>
...
<Accordion title="To add a new worklist, follow these steps:" icon="Plus">
  <Steps>
