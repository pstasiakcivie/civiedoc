...
2. Select **Decline** from the menu.

3. Choose **Occurrence** to remove only the selected instance.

4. Confirm the action by clicking **Yes** on the pop-up.

5. The **selected occurrence** is removed from the calendar.
...
3. Choose **Series** to remove all occurrences of the blocked slot.

4. Confirm the action by clicking **Yes** on the pop-up.

5. The **entire blocked slot series** is deleted from the calendar.
