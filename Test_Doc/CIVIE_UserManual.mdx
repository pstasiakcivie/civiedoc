...
1. Right-click on the **"+" icon** and select **Appointment Booking**.

2. The **Appointment Booking** pop-up appears.

3. **Select an existing patient** or **add a new patient**.

4. Choose the **referring physician** from the dropdown.

5. Search and **add the required exams**.

6. In the **Docs section**, any available documents for the selected patient will be displayed.

7. Click **Submit** to finalize the appointment.
...
4. Select the **location** using the provided dropdown.

5. Choose the **occurrence type**:
...
* Right-click on the **"+" icon** and select **Show Waitlist**.
