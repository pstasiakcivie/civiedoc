  ...
  <Step title="Under the Actions column, click on the **three-dot menu (**⋮) next to the required facesheet.">
    ...
    * Select **Delete** to permanently remove the facesheet.
    ...
    <Note>
      ...
      * *Deleted facesheets **cannot be recovered**, so proceed with caution.*
    </Note>
...
<Steps>
  ...
  <Step title="Filter ">
    ...
    <Note>
      ...
      * *Use the filter option to quickly find specific order* *entry*  *based on their status or date.*
    </Note>
...
![image.png](/.attachments/image-d4172b41-5519-4c37-adf1-f3c2e6288db4.png)**Coding Dashboard**
...
<Steps>
  ...
  <Step title="New Coding Worklist">
    ...
    * Check the checkbox only if you want the worklist to be visible to the logged in user. Mark the worklist as Private.
    ...
    <Note>
      ...
      * *Filter operations are used to select the operator for comparison (e.g., equals, contains, greater than).Preview the added Worklist to ensure it captures the desired criteria accurately and make the changes (if required).*
    </Note>
  ...
  <Step title="Click on Edit, select the field, and use add/delete tags to modify the values.">

  </Step>

  <Step title="Click on View Details to see detailed information about the coding tasks, including">
  ...
  <Step>
    ...
    <Note>
      ...
      * *If you add tags to modify the values. Changes made with tags will reflect a change in color status.*
...
<Steps>
  <Step title="Click on Menu > Common > Code to access the Code section.">
  ...
  <Step title="Use the search feature to find specific codes quickly.">
  ...
  <Step title="Filter">
    ...
    <Note>
      ...
      * *In the filter pallet when the "isActive" toggle option is disabled, it renders the list of 	inactive codes. By default, this toggle is enabled, showcasing the list of active codes.*
    </Note>
  ...
  <Step title=" Click Add Code to add new codes to the existing database seamlessly.">
    ...
    * Click *Edit*, to edit the codes seamlessly.
...
<Steps>
  ...
  <Step title="Filters ">
    ...
    <Info>
      *User can filter the ICD-Codes using Code, Category, Library, Parent Code, Order, Descriptions, Start and End Dates (MM/DD/YYYY).*
    </Info>
  </Step>
  ...
  <Step title="Add New ICD Code">
    ...
    * Click the **Save** button to add the new ICD code or click the cancel button to close the Add new ICD code window.
    ...
    <Note>
      ...
      * *Code and Start date are mandatory fields. Users need to fill in all the mandatory details.*
    </Note>
