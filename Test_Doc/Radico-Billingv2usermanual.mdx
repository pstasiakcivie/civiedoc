...
<Steps>
  ...
  <Step title="Apply the filters to refine the search results based on the specific criteria.">
    * &#x20;*In the filter pallet when the "isActive" toggle option is disabled, it renders the list of inactive codes. By default, this toggle is enabled, showcasing the list of active*.
...
<Steps>
  ...
  <Step title="IsActive indicates whether the ZIP-Code is currently active or inactive.">
...
### ![Picture30.png](/.attachments/Picture30-a8e6494e-686b-47fa-9b97-24915f2bea20.png)**Add new Worklist**
...
<Steps>
  <Step title="MY PRIVATE WORK-LIST:">
    *MY PRIVATE WORK-LIST:* All the private worklists added by the user for personalized tasks and activities are listed here.
  ...
  <Step title="SHARED WORK-LIST:">
    *SHARED WORK-LIST:* All the shared worklists added by the user for collaborative tasks and activities are listed here.
...
<Steps>
  ...
  <Step title="Filter Conditions">
    ...
    <Note>
      ...
      * *Filter operations are used to select the operator for comparison (e.g., equals, contains, greater than).*
    </Note>
